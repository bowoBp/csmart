...
func (_m *VersionGetterRepository) GetVersion() string {
	ret := _m.Called()
...
func (_c *VersionGetterRepository_GetVersion_Call) Return(_a0 string) *VersionGetterRepository_GetVersion_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *VersionGetterRepository_GetVersion_Call) RunAndReturn(run func() string) *VersionGetterRepository_GetVersion_Call {
	_c.Call.Return(run)
	return _c
}
